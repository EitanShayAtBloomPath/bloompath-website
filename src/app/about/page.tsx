...
Thanks!`
  ...
  return (
    <div className="font-sans text-gray-800">
      {/* Hero */}
      <section className="bg-gradient-to-r from-[--color-brand-teal] to-[--color-brand-green] text-white py-20 px-6">
      ...
      <section className="py-12 px-6 bg-green-50">
        <div className="max-w-5xl mx-auto">
          ...
          <ul className="grid md:grid-cols-2 gap-6 text-lg">
            ...
            <li className="p-5 bg-white rounded-2xl shadow">
              <span className="font-semibold">Privacy by Design:</span> HIPAA-minded, minimal data exposure, clear consent.
            </li>
          </ul>
        </div>
      </section>
...
<section className="py-16 px-6">
  <div className="max-w-5xl mx-auto">
    ...
    <div className="mt-10 p-6 bg-white rounded-2xl border">
      ...
      <p className="text-lg">
        We’re assembling a pediatric, nutrition, and behavioral health advisory group 
        to guide protocols, training, and safety.
      </p>
    </div>
  </div>
</section>
      ...
      {/* CTA */}
      <section className="bg-gradient-to-r from-[--color-brand-green] to-[--color-brand-teal] text-white py-16 px-6 text-center">
